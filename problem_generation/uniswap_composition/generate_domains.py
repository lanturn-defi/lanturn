...
dir = '../../eth_token_tests_uniswap_composition'
...
for filename in glob.glob(dir+'/*'):
    ...
    lines = ["alpha1,0,{}".format(int(10**(3+18))), "alpha2,0,{}".format(int(10**(3+18))), "alpha3,0,{}".format(int(10**(3+18))), 
            "alpha4,0,{}".format(int(10**(9+token_decimals))),"alpha5,0,{}".format(int(10**(9+token_decimals))), "alpha6,0,{}".format(int(10**(9+token_decimals))),
            "alpha7,0,1000", "alpha8,0,{}".format(int(10**(9+token_decimals)))]
